f = open("bmi_output.txt", "a") #otwiera się plik tekstowy o nazwie bmi_output
...
def imperialne(): #funkcja dla wartości imperialnych
    while True:
        ...
        print(f'Wzrost: {wzrost_imp}in, Waga: {waga_funty}lb, BMI: {bmi}', file=f) #zapisanie wartości do pliku tekstowego
...
def metryczne(): #funkcja dla wartości metrycznych
    while True:
        ...
        print(f'Wzrost: {wzrost}m, Waga: {waga}kg, BMI: {bmi}', file=f) #zapisanie wartości do pliku tekstowego
